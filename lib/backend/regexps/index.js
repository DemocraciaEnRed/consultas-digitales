...
for (var key in exports) {
  if (key === 'strings')
    continue
  if (exports[key].test !== undefined) {
    exports.strings[key] = exports[key].toString()
  }else if (typeof exports[key] === 'object' && Object.keys(exports[key])){
    var keys = Object.keys(exports[key])
    for (var i in keys){
      var subkey = keys[i]
      if (exports.strings[key] === undefined)
        exports.strings[key] = {}
      exports.strings[key][subkey] = exports[key][subkey].toString()
    }
  }
}