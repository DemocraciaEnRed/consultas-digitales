...
var tagImages = require('lib/backend/tags-images')
...
app.get('/tag/tag-images', function (req, res) {
  log('Request /tag/tag-images %j', req.query)
  log('Serving tag images %j', tagImages)
  res.status(200).json(tagImages)
})
