const expose = require('lib/backend/utils').expose
...
exports.ordinary.selectToAdmin = exports.ordinary.keysForAdmin.expose.concat(
  exports.ordinary.keysForAdmin.select
).join(' ')
...
exports.ordinary.exposeToAdmin = (function () {
  const exposeFields = expose(exports.ordinary.keysForAdmin.expose.concat(
    userScopes.ordinary.keys.expose.map((v) => `author.${v}`)
  ))
