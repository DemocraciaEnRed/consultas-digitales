...
const sslRedirect = require('lib/backend/server-factory/ssl-redirect')
const config = require('lib/config')
const l10n = require('lib/backend/l10n')
const jwt = require('lib/backend/jwt')
...
function Setup (app) {
  ...
  app.use(require('lib/backend/middlewares/twitter-card-middleware'))
  app.use(require('lib/backend/middlewares/facebook-card-middleware'))
}
