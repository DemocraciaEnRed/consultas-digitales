...
import title from 'lib/frontend/title/title'
import topicStore from 'lib/frontend/stores/topic-store/topic-store'
import { loadCurrentForum } from 'lib/frontend/forum/forum'
import AdminPermissions from '../admin-permissions/admin-permissions'
import { findPrivateTopics,
         findTopic } from 'lib/frontend/topic-middlewares'
import { findAllTags,
         findTag,
         clearTagStore } from 'lib/frontend/tag-middlewares'
import { privileges, visibilities } from 'lib/frontend/forum-middlewares'
...
page(urlBuilder.for('admin.permissions'), privileges('canEdit'), visibilities, (ctx) => {
