        ...
        }
        {
          ...
          (
            <div id='welcome-message'>
              <h1>
                { t('signup.welcome-can-vote', { name: this.props.user.state.value.firstName }) }
              </h1>
              <p className='lead'>
                {t('signup.email-validated')}.
              </p>
              <p className='lead'>
                {t('signup.now-can-vote', {organizationName: config.organizationName})}
              </p>
              <p className='lead browsing'>
                <Link
                  to='/'
