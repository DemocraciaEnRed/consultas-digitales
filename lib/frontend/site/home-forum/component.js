...
import checkReservedNames from 'lib/frontend/forum/check-reserved-names'
...
export class HomeForum extends Component {
  ...
  componentWillMount () {
    ...
    forumStore.getReservedNames().then((reservedNames) => {
      if (!checkReservedNames(reservedNames,name))
