    ...
    return (
      <div className='ext-site-home-multiforum'>
        <section
          ...
          style={{
            backgroundImage: `url('/lib/frontend/site/home-multiforum/header-background.jpeg')`
          }}>
          <div className='jumbotron_body'>
            <div className='container'>
              <img
                src="/lib/frontend/site/home-multiforum/logo-grande-consultas-digitales.png"
                alt="Logo"
                width="270px"
              />
        ...
        <div className='section-icons col-md-10 offset-md-1'>
          <div className='row'>
            <div className='section-icon col-md-4'>
              <img
                className='icon'
                src='/lib/frontend/site/home-multiforum/icono_consulta-publica-1.svg'
                alt='Informate'
              />
              <div className='text'>
            ...
            <div className='section-icon col-md-4'>
             <img
                className='icon'
                src='/lib/frontend/site/home-multiforum/icono_consulta-publica-2.svg'
                alt='Participá'
              />
              <div className='text'>
            ...
            <div className='section-icon col-md-4'>
             <img
                className='icon'
                src='/lib/frontend/site/home-multiforum/icono_consulta-publica-3.svg'
                alt='Compartí'
              />
              <div className='text'>
