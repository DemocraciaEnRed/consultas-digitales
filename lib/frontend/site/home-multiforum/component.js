    ...
    return (
      <div className='ext-site-home-multiforum'>
        ...
        <div className='lead-paragraph'>
          <p>
            <span className="skyblue">{config.organizationName}</span> Consultas Digitales permite a la ciudadanía comentar, votar, jerarquizar, optar entre opciones, o establecer grados de valoración sobre algún tema público.
          </p>
          <br />
          <p className="bold">
