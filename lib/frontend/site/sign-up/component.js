              ...
              <FormAsync
                ...
                : <div className='form-group'>
                  ...
                  <input
                    ...
                    required />
                    <br/>
                    <a className="btn btn-sm btn-secondary btn-block" onClick={this.createRandomString}>Crear una constraseña al azar</a>
                </div>
                }
                { config.allowPublicSignUp ?
        ...
        }
        {
          ...
          (
            ...
            : <div id='signup-message'>
              ...
              <p className='lead'>Hemos enviamos un correo electrónico al usuario con sus datos de acceso.</p>
              <p className='lead'>Recuerdele al usuario que no te olvide revisar el Correo no Deseado.</p>
              <a
